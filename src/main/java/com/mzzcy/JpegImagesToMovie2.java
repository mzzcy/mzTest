package com.mzzcy;/*
 * @(#)JpegImagesToMovie2.java	1.3 01/03/13
 *
 ...
 */
public class JpegImagesToMovie2  {
...
//    static void prUsage() {
//        System.err.println(
//            "Usage: java JpegImagesToMovie2 -w <width> -h <height> -f <frame rate> -o <output URL> <input JPEG file 1> <input JPEG file 2> ...");
//        System.exit(-1);
//    }
//
//    /**
...
//
//            format =
//                new JPEGFormat(new Dimension(width, height), Format.NOT_SPECIFIED, Format.byteArray, (float)frameRate,
//                    75, JPEGFormat.DEC_422);
//        }
//
//        /**
